      ...
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        >
          ...
          <div ref={ref} className="reveal lg:sticky" style={{ top: 'calc(var(--header-h) + 2rem)' }}>
            ...
            <p className="text-ink-soft mt-4" style={{ fontSize: '0.975rem' }}>
              {t('about.desc1')}
            </p>
            <p className="text-ink-soft mt-3" style={{ fontSize: '0.975rem' }}>
              {t('about.desc2')}
            </p>

            <blockquote
              className="font-display font-light italic mt-6 leading-relaxed pl-6"
              style={{
                fontSize: '1.5rem',
                borderLeft: '2px solid var(--rose-mid)',
                color: 'var(--ink)',
              }}
            >
              {t('about.quote')}
...
function TimelineItem({ period, title, desc, delay }: TimelineItemProps) {
  ...
  return (
    ...
    >
      <p
        className="text-[0.7rem] font-medium tracking-[0.12em] uppercase mb-1"
